...
The final stage at the end of this sprint is shown on Figure~\ref{fig:sprint1-final-stage}.
\begin{figure}
  \centering
  \includegraphics[width=13cm, keepaspectratio]{img/final-stage-sprint1}
  \caption{Final stage - Sprint 1}
  \label{fig:sprint1-final-stage}
\end{figure}

For a better understanding a general architecture for this sprint is shown on Figure.
\begin{figure}
  \centering
