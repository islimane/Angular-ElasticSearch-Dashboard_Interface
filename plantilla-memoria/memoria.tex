...
In this project that it has been developed the main objective is the development of a web application whose features have been extracted from the \textit{Kibana} application in order to create a simplified version of it. To achieve this we are going to use different technologies such as \textit{Elasticsearch}, to store and manage the application's data, and \textit{Angular} as the main front-end technology, with which we are going to implement the user interface and all the application's features.
