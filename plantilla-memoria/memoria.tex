...
\lstdefinelanguage{JavaScript}{
 	keywords={\$, Number, constructor, typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break},
  	keywordstyle=\color{keyword},
  	ndkeywords={private, public, Router, class, export, boolean, throw, implements, import, this,prototype, then},
