...
\chapter{Estado del Arte y Tecnologías} % título del capítulo (se muestra)
\label{chap:estado-arte} % identificador del capítulo (no se muestra, es para poder referenciarlo)
